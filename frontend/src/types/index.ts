...
export type BronzeMappingKowil = {
  mapping_id: number;
  kowil_lama_2024?: string | null;
  kowil_baru_feb25?: string | null;
  kowil_baru_sept25?: string | null;
  spv_2?: string | null;
  asm_2?: string | null;
  rsm?: string | null;
  nama_asm?: string | null;
  nama_karyawan?: string | null;
  nama_mso?: string | null;
  source_sheet?: string | null;
  dwh_loaded_at?: string | null; // datetime dari backend biasanya ISO string
};
